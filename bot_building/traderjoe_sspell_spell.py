...
def main():
    ...
    try: 
        ...
        # Avalanche support EIP-1559 transactions, so we set the priority fee
    ...
    while True:
        ...
        if spell["balance"]:
            ...
            # execute SPELL -> sPELL arb if trigger is satisifed
            ...
            if sspell["balance"]:
                ...
                if result := get_swap_rate(
                    ...
                    # print and save any update swap values since last loop 
                ...
                # execute sSPELL -> SPELL arb if trigger is satisified 
