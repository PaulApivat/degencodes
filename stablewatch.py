...
# Data Structures
# Generally cleaner to create a special class for these coins, but keep it simple python dict for now
...
# Main Program
# condition if qty_out >= 1.01 are trades that deliver a min 1% profit.
while True:
